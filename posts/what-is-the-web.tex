...
\begin{document}
  ...
  But I think PDFs are more than just a file fad. So much so that every major browswer (Chrom, Safari, Firefox) has built in support for viewing PDFs in the browser. So imagine for a moment that every page on the web was just a PDF rather than an HTML page. Not much would fundamentally change, because both PDFs and HTML have the same funcionality. 
  ...
  Okay so hypothetically you \textit{could} replace HTML documents with PDF documents. But why, right? I have a couple of reasons, some more valid than others. 
